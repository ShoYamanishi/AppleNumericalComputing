#ifndef __TEST_CASE_LCP_LEMKE_VDSP_H__
#define __TEST_CASE_LCP_LEMKE_VDSP_H__
#include <iostream>
#include <vector>
#include <limits>
#include <string>
...
class TestCaseLCP_lemke_vdsp : public TestCaseLCP<T, IS_COL_MAJOR> {
  ...
  public:
    ...
    TestCaseLCP_lemke_vdsp( const int dim, const T condition_num, const int max_num_iterations, const T epsilon, const LCPTestPatternType p_type )
    ...
    virtual ~TestCaseLCP_lemke_vdsp(){
...
#endif /*__TEST_CASE_LCP_LEMKE_VDSP_H__*/
