...
class TestCaseLCP_lemke_neon : public TestCaseLCP<T, IS_COL_MAJOR> {
  ...
  public:
    ...
    TestCaseLCP_lemke_neon( const int dim, const T condition_num, const int max_num_iterations, const T epsilon, const LCPTestPatternType p_type )
        ...
        ,m_max_num_iterations ( max_num_iterations )
    {
        ...
        if constexpr( is_same<float, T>::value ) {
            this->setCPPBlock( 1, 4 );
        }
        else {
            this->setCPPBlock( 1, 2 );
        }
