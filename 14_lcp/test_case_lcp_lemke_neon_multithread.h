#ifndef __TEST_CASE_LCP_LEMKE_NEON_MULTITHREAD_H__
#define __TEST_CASE_LCP_LEMKE_NEON_MULTITHREAD_H__
#include <iostream>
#include <vector>
#include <limits>
#include <string>
...
class TestCaseLCP_lemke_neon_multithread : public TestCaseLCP<T, IS_COL_MAJOR> {
  ...
  public:
    ...
    TestCaseLCP_lemke_neon_multithread( const int dim, const T condition_num, const int max_num_iterations, const T epsilon, const int num_threads, const LCPTestPatternType p_type )
        ...
        ,m_leaving_row_index  ( -1 )
    {
        ...
        if constexpr( is_same<float, T>::value ) {
            this->setCPPBlock( num_threads, 4 );
        }
        else {
            this->setCPPBlock( num_threads, 2 );
        }
        this->setImplementationType( LEMKE_NEON );
    ...
    virtual ~TestCaseLCP_lemke_neon_multithread(){
    ...
    void  pivot( const int entering_col_index, const int leaving_row_index ) {
        ...
        pivot_row[ m_entering_col_index ] = 1.0;
    }
...
#endif /*__TEST_CASE_LCP_LEMKE_NEON_MULTITHREAD_H__*/
